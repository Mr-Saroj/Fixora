/**
 * Customer Sidebar Utility Functions & Configuration
 * @file customerSidebarUtils.js
 * @description Static links, breakpoints, and pure CSS class builder functions
 */
 ...
 * @param {number} breakpoint - Pixel threshold (default: 1024)
 * @returns {boolean}
 */
...
export const getBottomLinkClasses = () => {
